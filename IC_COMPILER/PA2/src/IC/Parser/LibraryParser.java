...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Dec 01 16:33:11 IST 2012
  */
public @SuppressWarnings(value={"all"}) class LibraryParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\044\000\004\032\004\001\002\000\004\060\007\001" +
    "\002\000\004\002\006\001\002\000\004\002\000\001\002" +
    "\000\004\012\010\001\002\000\006\013\ufffd\051\011\001" +
    "\002\000\014\014\020\030\021\052\014\056\017\060\016" +
    "\001\002\000\004\013\013\001\002\000\004\002\001\001" +
    "\002\000\006\010\ufffa\026\ufffa\001\002\000\006\010\032" +
    "\026\041\001\002\000\006\010\ufff9\026\ufff9\001\002\000" +
    "\004\026\022\001\002\000\006\010\ufffb\026\ufffb\001\002" +
    "\000\006\010\ufffc\026\ufffc\001\002\000\004\006\023\001" +
    "\002\000\014\007\ufff6\014\020\030\021\052\014\060\016" +
    "\001\002\000\006\010\032\026\031\001\002\000\004\007" +
    "\026\001\002\000\004\050\027\001\002\000\006\013\ufffd" +
    "\051\011\001\002\000\004\013\ufffe\001\002\000\006\007" +
    "\ufff4\016\034\001\002\000\004\011\033\001\002\000\006" +
    "\010\ufff8\026\ufff8\001\002\000\012\014\020\030\021\052" +
    "\014\060\016\001\002\000\004\007\ufff7\001\002\000\006" +
    "\010\032\026\037\001\002\000\006\007\ufff4\016\034\001" +
    "\002\000\004\007\ufff5\001\002\000\004\006\042\001\002" +
    "\000\014\007\ufff6\014\020\030\021\052\014\060\016\001" +
    "\002\000\004\007\044\001\002\000\004\050\045\001\002" +
    "\000\006\013\ufffd\051\011\001\002\000\004\013\uffff\001" +
    "\002" });
  ...
  public final java_cup.runtime.Symbol CUP$LibraryParser$do_action(
	...
	RESULT = lstFormals;
		...
		Object c = (Object)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.peek()).value;
		 ...
		 RESULT = new PrimitiveType(parser.getLine(), DataTypes.INT); 
          ...
          case 4: // libmethod ::= 
            {
              Object RESULT =null;
		 RESULT = new ArrayList<StaticMethod>(); 
		...
		Object lstMethods = (Object)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.peek()).value;
		  ArrayList<StaticMethod> methods = (ArrayList<StaticMethod>)lstMethods;
	methods.add(new StaticMethod(new PrimitiveType(parser.getLine(),DataTypes.VOID), i.toString(), (ArrayList<Formal>)lstFormals,((List<Statement>)new ArrayList<Statement>())));
	RESULT = methods; 
		...
		Object lstMethods = (Object)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.peek()).value;
		  ArrayList<StaticMethod> methods = (ArrayList<StaticMethod>)lstMethods;
	methods.add(new StaticMethod((Type)t, i.toString(), (ArrayList<Formal>)lstFormals,((List<Statement>)new ArrayList<Statement>())));
	RESULT = methods; 
              CUP$LibraryParser$result = parser.getSymbolFactory().newSymbol("libmethod",1, ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-7)), ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.peek()), RESULT);
            }
          return CUP$LibraryParser$result;
		...
		Object l = (Object)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-2)).value;
		int mleft = ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)).left;
		int mright = ((java_cup.runtime.Symbol)CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)).right;
		Object m = (Object)((java_cup.runtime.Symbol) CUP$LibraryParser$stack.elementAt(CUP$LibraryParser$top-1)).value;
