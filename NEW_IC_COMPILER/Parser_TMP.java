...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Dec 10 14:42:36 IST 2012
  */
public @SuppressWarnings(value={"all"}) class Parser_TMP extends java_cup.runtime.lr_parser {

  /** Default constructor. */
  public Parser_TMP() {super();}

  /** Constructor which sets the default scanner. */
  public Parser_TMP(java_cup.runtime.Scanner s) {super(s);}

  /** Constructor which sets the default scanner. */
  public Parser_TMP(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {super(s,sf);}
...
class CUP$Parser$actions {
  private final Parser_TMP parser;

  /** Constructor */
  CUP$Parser$actions(Parser_TMP parser) {
    this.parser = parser;
  }
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Object argsList = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new VirtualCall(parser.getLine(),id.toString(),(List<Expression>)argsList); 
		...
		Object stm = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
						...
						RESULT = new While((Expression)condition, new StatementsBlock(parser.getLine(), (List<Statement>)stm)); 
		...
		int eright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		Object e = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = (e==null)? new Return(parser.getLine()): new Return(parser.getLine(),(Expression)e); 	
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("Statement",14, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		Object fom = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 Object[] arr = new Object[2];
  				  											arr = (Object[])fom;		
  				  											((ArrayList<Field>)arr[0]).add((Field)field);
 				  											RESULT = arr; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("FieldOrMethod",4, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
