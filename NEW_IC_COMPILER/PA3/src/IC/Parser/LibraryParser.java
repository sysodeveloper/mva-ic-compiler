...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Jan 01 15:45:43 IST 2013
  */
...
class CUP$LibraryParser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$LibraryParser$do_action(
	...
	methods.add(0, new LibraryMethod(new PrimitiveType(parser.getLine(),DataTypes.VOID), i.toString(), (ArrayList<Formal>)lstFormals));
	RESULT = methods; 
