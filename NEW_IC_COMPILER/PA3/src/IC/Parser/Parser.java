...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Dec 30 19:09:07 IST 2012
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Object stmList = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
							   		...
							   		else if (stm instanceof StatementsBlock){
							   			((ArrayList<Statement>)stmList).add((StatementsBlock)stm);
							   		}
							   		else if (stm instanceof List<?>){
							   			for(Statement s: (ArrayList<Statement>)stm ){
							   				((ArrayList<Statement>)stmList).add((Statement)s);
							   			}							   		
							   		}
